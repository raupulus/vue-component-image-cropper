(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CropperImage"] = factory();
	else
		root["CropperImage"] = factory();
...
/* harmony default export */ var clipper_rangevue_type_script_lang_js_ = ({
  ...
  subscriptions() {
    ...
    this.mouseEvent$ = this.mousedown$.pipe(Object(map["a" /* map */])(e => {
      e.event.preventDefault();
      return e.event;
    }), Object(concatMap["a" /* concatMap */])(() => this.mousemove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.mouseup$), Object(map["a" /* map */])(e => e.clientX))), Object(merge["a" /* merge */])(this.mousedown$.pipe(Object(map["a" /* map */])(e => e.event.clientX))));
    this.touchEvent$ = this.touchstart$.pipe(Object(map["a" /* map */])(e => {
      e.event.preventDefault();
      return e.event;
    }), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(map["a" /* map */])(e => e.touches[0].clientX))), Object(merge["a" /* merge */])(this.touchstart$.pipe(Object(map["a" /* map */])(e => e.event.touches[0].clientX))));
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("a4bb")
...
// Module
exports.push([module.i, ".v-component-image-cropper[data-v-a645eeae]{margin:auto;text-align:center;width:100%}.v-component-image-cropper .v-application--wrap[data-v-a645eeae]{min-height:20px!important}.v-component-image-cropper-button-open-modal .icon-open-modal[data-v-a645eeae]{display:block;margin:-20px auto 0 auto;padding:8px!important;width:45px;background-color:#fff;border:4px solid #2f4f4f;border-radius:9999px}.align-center[data-v-a645eeae]{text-align:center}.align-top[data-v-a645eeae]{vertical-align:top}.ml--15[data-v-a645eeae]{margin-left:-15px}.avatar-icon[data-v-a645eeae]{left:auto;bottom:5px!important;height:25px;width:25px}.rounded-full[data-v-a645eeae]{border-radius:9999px}", ""]);
// Exports
module.exports = exports;
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_1_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_1_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("9c391a88", content, true, {"sourceMap":false,"shadowMode":false});
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_preview_vue_vue_type_style_index_0_id_7c25a830_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_preview_vue_vue_type_style_index_0_id_7c25a830_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".v-component-image-cropper-modal[data-v-eab48d34]{position:fixed!important;top:0;left:0;z-index:9999999999}.my-cropper-upload-errors[data-v-eab48d34]{color:red}.my-clipper[data-v-eab48d34]{max-width:300px}", ""]);
// Exports
module.exports = exports;
...
/* harmony default export */ var clipper_basicvue_type_script_lang_js_ = ({
  ...
  subscriptions() {
    ...
    Object(map["a" /* map */])(e => this.eInZoom(e)), // 點擊時zoom的position,rect
    Object(concatMap["a" /* concatMap */])( // 將down (zoom rect), move交給後續
    () => this.mousemove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.mouseup$)), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.touchdownDrag$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(this.isDragElement), Object(filter["a" /* filter */])(e => e.touches.length === 1), // 單指
    Object(tap["a" /* tap */])(this.prevent), // deal with down, we want to calc down just for once.
    Object(map["a" /* map */])(e => this.eInZoom(e.touches[0])), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(filter["a" /* filter */])(e => e.touches.length === 1), // 單指
    Object(map["a" /* map */])(e => e.touches[0])), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.mousedownZoom$ = new Subject["a" /* Subject */]().pipe(Object(merge["a" /* merge */])(this.mousedown$), Object(filter["a" /* filter */])(this.isZoomElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(this.setDownPosition), Object(concatMap["a" /* concatMap */])(() => this.mousemove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.mouseup$)), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.touchdownZoom$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(this.isZoomElement), Object(filter["a" /* filter */])(e => e.touches.length === 1), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(this.setDownPosition), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(filter["a" /* filter */])(e => e.touches.length === 1), Object(map["a" /* map */])(e => e.touches[0])), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.touchTwoFingersZoom$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(e => {
      return e.touches.length === 2;
    }), Object(filter["a" /* filter */])(this.isTwoPointZoomElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(() => {
    ...
    }), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(filter["a" /* filter */])(e => e.touches.length === 2), Object(tap["a" /* tap */])(this.prevent), Object(takeUntil["a" /* takeUntil */])(this.touchend$)), (down, move) => {
      return this.getTwoTouchesPos(down.event, move, down.zoom);
    }));
    this.mousedownCreate$ = this.mousedown$.pipe(Object(filter["a" /* filter */])(this.isCreateElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(this.getFakeDown), Object(concatMap["a" /* concatMap */])(() => this.mousemove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.mouseup$)), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.touchstartCreate$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(this.isCreateElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(e => e.touches[0]), Object(map["a" /* map */])(this.getFakeDown), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(takeUntil["a" /* takeUntil */])(this.stop$), // 兩指事件觸發時停止
    Object(filter["a" /* filter */])(e => e.touches.length === 1), // 單指
    Object(filter["a" /* filter */])(() => this.touchCreate)), (down, move) => {
      // down is fake
      return {
        down,
        move: move.touches[0]
    ...
    */
    ...
    this.dragCreateSubject$ = this.mousedownCreate$.pipe(Object(merge["a" /* merge */])(this.touchstartCreate$), Object(map["a" /* map */])(({
      down,
      move
    }) => {
      return {
    ...
    Object(map["a" /* map */])(this.setRatioWH), Object(map["a" /* map */])(this.toPercentage), Object(map["a" /* map */])(this.splitPos), Object(map["a" /* map */])(split => {
    ...
    posObj: function () {
      ...
      for (let k in this.zoomTL$) {
        if (typeof this.zoomTL$[k] === 'number') {
          style[k] = `${this.zoomTL$[k]}% !important`;
        }
      }
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("da15")
if (style0.__inject__) style0.__inject__(context)
...
/* harmony default export */ var clipper_fixedvue_type_script_lang_js_ = ({
  ...
  subscriptions() {
    ...
    this.mousedownDrag$ = this.mousedown$.pipe(Object(filter["a" /* filter */])(this.isDragElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(this.dragDownPos), Object(concatMap["a" /* concatMap */])(() => this.mousemove$.pipe(Object(tap["a" /* tap */])(this.prevent), Object(takeUntil["a" /* takeUntil */])(this.mouseup$)), (down, move) => {
      return {
        down,
        move
      };
    }));
    this.touchdownDrag$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(this.isDragElement), Object(tap["a" /* tap */])(this.prevent), Object(filter["a" /* filter */])(e => e.touches.length === 1), Object(map["a" /* map */])(e => e.touches[0]), Object(map["a" /* map */])(this.dragDownPos), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(filter["a" /* filter */])(e => e.touches.length === 1)), (down, move) => {
      return {
        down,
        move: move.touches[0]
      };
    }));
    this.wheelEvent$ = this.wheel$.pipe(Object(filter["a" /* filter */])(this.isDragElement), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(e => e.deltaY), Object(map["a" /* map */])(deltaY => deltaY >= 0 ? -1 : 1));
    this.touchTwoFinger$ = this.touchstart$.pipe(Object(filter["a" /* filter */])(this.isDragElement), Object(filter["a" /* filter */])(e => e.touches.length === 2), Object(tap["a" /* tap */])(this.prevent), Object(map["a" /* map */])(this.towPointsTouches), Object(map["a" /* map */])(this.setOrigin), Object(concatMap["a" /* concatMap */])(() => this.touchmove$.pipe(Object(takeUntil["a" /* takeUntil */])(this.touchend$), Object(filter["a" /* filter */])(e => e.touches.length === 2), Object(map["a" /* map */])(this.towPointsTouches)), ({
      down,
      origin
    }, move) => {
      return {
  ...
  methods: {
    ...
    resetData: function () {
      ...
      const scale = this.ratio > this.imgRatio ? this.imgRatio / this.ratio : 1;
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("9f4a")
if (style0.__inject__) style0.__inject__(context)
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_fixed_vue_vue_type_style_index_0_id_fb0a7a42_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_fixed_vue_vue_type_style_index_0_id_fb0a7a42_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_range_vue_vue_type_style_index_0_id_7f413ba8_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_range_vue_vue_type_style_index_0_id_7f413ba8_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperImage_vue_vue_type_style_index_0_id_a645eeae_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c326");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperImage_vue_vue_type_style_index_0_id_a645eeae_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperImage_vue_vue_type_style_index_0_id_a645eeae_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
...
// load the styles
var content = __webpack_require__("34ed");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("426e00b9", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_0_id_eab48d34_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("4490");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_0_id_eab48d34_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_0_id_eab48d34_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_0_id_eab48d34_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CropperModal_vue_vue_type_style_index_0_id_eab48d34_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("4b68")
if (style0.__inject__) style0.__inject__(context)
  ...
  methods: {
    ...
    checkEXIF: function () {
      return new Promise((resolve, reject) => {
        ...
        resolve();
      }).then(() => this.getEXIF()).then(orientation => this.getImageRect().then(({
        width,
        height
      }) => {
      ...
      }).catch(() => Promise.reject(new Error()))).then(this.tranformCanvas).catch(() => Promise.resolve()); // just use catch to escape chains
    },
    getEXIF: function () {
      return new Promise((resolve, reject) => {
    ...
    tranformCanvas: function ({
      ...
      const canvas = document.createElement('canvas');
      const ctx = canvas.getContext('2d'); // set proper canvas dimensions before transform & export
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_basic_vue_vue_type_style_index_0_id_3b010166_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _vue_style_loader_index_js_ref_8_oneOf_1_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_src_index_js_ref_8_oneOf_1_2_postcss_loader_src_index_js_ref_8_oneOf_1_3_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_cache_loader_dist_cjs_js_ref_0_0_vue_loader_lib_index_js_vue_loader_options_clipper_basic_vue_vue_type_style_index_0_id_3b010166_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"70a4d654-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/CropperImage.vue?vue&type=template&id=a645eeae&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-component-image-cropper"},[_c('input',{attrs:{"type":"hidden","name":_vm.input_name},domProps:{"value":_vm.inputValue}}),_c('div',{staticClass:"w-auto mx-auto center",on:{"mouseover":function($event){_vm.showModalButton = true},"mouseout":function($event){_vm.showModalButton = false}}},[_c('div',{staticClass:"cursor-pointer",on:{"click":_vm.toggleModal}},[_c('img',{staticClass:"mx-auto bg-black border-2 border-black shadow-md",style:(_vm.rounded ? 'border-radius: 50%;' : ''),attrs:{"src":_vm.image.src,"alt":_vm.image.name,"width":_vm.preview_width}})]),_c('div',{staticClass:"v-component-image-cropper-button-open-modal -mt-12 cursor-pointer center"},[_c('svg',{staticClass:"icon-open-modal svg-icon cursor-pointer transition transition-delay-1000 rounded ease",style:(_vm.showModalButton ? 'opactiy: 1;' : 'opacity: 0;'),attrs:{"viewBox":"0 0 16 16"},on:{"click":_vm.toggleModal}},[_c('path',{attrs:{"d":"M10.5 8.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"}}),_c('path',{attrs:{"fill-rule":"evenodd","d":"M2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4H2zm.5 2a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1zm9 2.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0z"}})])])]),_c('v-image-cropper-modal',{attrs:{"dialog":_vm.modal.dialog,"originalImage":_vm.image.src,"originalLazy":_vm.image.lazy,"has_api":_vm.api.has_api,"api_url":_vm.api.url,"ratio":_vm.aspect_ratio,"width":_vm.width},on:{"modal_cropper_update_data":_vm.onChangeModalCropperData}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/CropperImage.vue?vue&type=template&id=a645eeae&scoped=true&
...
/* harmony default export */ var CropperModalvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    save() {
      console.log('save()');
      const clipper = this.$refs.clipper; // Recorta la imagen fijando el ancho y por tanto proporción sobre este.
...
function injectStyles (context) {
  ...
  var style0 = __webpack_require__("c9db")
if (style0.__inject__) style0.__inject__(context)
var style1 = __webpack_require__("3690")
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  CropperModalvue_type_template_id_eab48d34_scoped_true_render,
  CropperModalvue_type_template_id_eab48d34_scoped_true_staticRenderFns,
  false,
  injectStyles,
  "eab48d34",
  null
...
// EXTERNAL MODULE: ./src/components/CropperImage.vue?vue&type=style&index=0&id=a645eeae&lang=scss&scoped=true&
var CropperImagevue_type_style_index_0_id_a645eeae_lang_scss_scoped_true_ = __webpack_require__("b736");
...
//# sourceMappingURL=CropperImage.umd.js.map